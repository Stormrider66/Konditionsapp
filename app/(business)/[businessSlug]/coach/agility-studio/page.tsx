// app/(business)/[businessSlug]/coach/agility-studio/page.tsx
// Multi-tenant Agility Studio page for coaches
...
export default async function AgilityStudioPage({ params }: PageProps) {
