// app/(business)/[businessSlug]/athlete/workouts/[id]/page.tsx
...
import { ArrowLeft, CheckCircle2, Clock, MapPin, Calendar, Edit, Info, Activity, Zap, Utensils } from 'lucide-react'
...
interface BusinessWorkoutDetailPageProps {
  params: Promise<{
    businessSlug: string
    id: string
  }>
