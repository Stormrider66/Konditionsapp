// app/(business)/[businessSlug]/athlete/agility/page.tsx
// Multi-tenant agility page for athletes
...
export default async function BusinessAthleteAgilityPage({ params }: PageProps) {
