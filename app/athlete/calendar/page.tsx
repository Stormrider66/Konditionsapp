...
export default async function AthleteCalendarPage() {
  const t = await getTranslations('pages.athleteCalendar')
      ...
      <div className="container mx-auto py-12 px-4 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="font-display text-4xl font-bold italic uppercase tracking-tight mb-1 transition-colors">
