 ...
 * Organizations Page
 *
 * Manage organizations (groups of teams like "IFK Göteborg" with U19, U21, Senior)
 * - Create/edit/delete organizations
 * - View teams within each organization
 * - Link to team dashboards
 */
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <h3 className="text-lg font-medium mb-2">Inga organisationer ännu</h3>
