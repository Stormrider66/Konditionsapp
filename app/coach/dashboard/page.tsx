    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      <div className="container mx-auto py-6 px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <TodaysAppointmentsCard variant="compact" />
          ...
          <GlassCard>
            ...
            <GlassCardContent>
              <div className="space-y-3">
                ...
                <Link href="/coach/analytics" className="block">
          ...
          <div className="space-y-6">
                ...
                {recentTests.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {recentTests.slice(0, 3).map(test => (
                      <Link
                        key={test.id}
                        href={`/clients/${test.client.id}/tests/${test.id}`}
                    ...
                    <Link href="/test" className="block text-center">
                      <Button variant="ghost" size="sm" className="text-xs w-full">
            ...
            <GlassCard>
              ...
              <GlassCardContent className="grid grid-cols-2 gap-2">
                ...
                <Link href="/coach/ai-studio" className="block">
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-muted/30 dark:bg-white/5 hover:bg-muted dark:hover:bg-white/10 transition text-center">
                    <Sparkles className="h-5 w-5 text-purple-500" />
                    <span className="text-xs dark:text-slate-300">AI Studio</span>
                  </div>
                </Link>
                <Link href="/coach/video-analysis" className="block">
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-muted/30 dark:bg-white/5 hover:bg-muted dark:hover:bg-white/10 transition text-center">
                    <Video className="h-5 w-5 text-red-500" />
                    <span className="text-xs dark:text-slate-300">Video</span>
                  </div>
                </Link>
                <Link href="/coach/strength" className="block">
                  <div className="flex flex-col items-center gap-2 p-3 rounded-lg bg-muted/30 dark:bg-white/5 hover:bg-muted dark:hover:bg-white/10 transition text-center">
