...
const createTestSchema = z.object({
  ...
  rampDurationSec: z.number().int().positive().optional(),
  peakSpeedKmh: z.number().positive().optional(),
  rerMax: z.number().positive().optional(),
  veMax: z.number().positive().optional(),
  breathingFrequencyMax: z.number().positive().optional(),
  economyMlKgKm: z.number().positive().optional(),
  hrRecovery1Min: z.number().int().optional(),
  hrRecovery2Min: z.number().int().optional(),
  lactateClearance3Min: z.number().optional(),
  lactateClearance5Min: z.number().optional(),
  lactateClearance10Min: z.number().optional(),
  // Strength
  ...
  try {
    ...
    const test = await prisma.hockeyPhysicalTest.create({
      data: {
        ...
        rampDurationSec: parsed.data.rampDurationSec,
        peakSpeedKmh: parsed.data.peakSpeedKmh,
        rerMax: parsed.data.rerMax,
        veMax: parsed.data.veMax,
        breathingFrequencyMax: parsed.data.breathingFrequencyMax,
        economyMlKgKm: parsed.data.economyMlKgKm,
        hrRecovery1Min: parsed.data.hrRecovery1Min,
        hrRecovery2Min: parsed.data.hrRecovery2Min,
        lactateClearance3Min: parsed.data.lactateClearance3Min,
        lactateClearance5Min: parsed.data.lactateClearance5Min,
        lactateClearance10Min: parsed.data.lactateClearance10Min,
