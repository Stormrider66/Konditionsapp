...
const Z_SCORE_METRICS = [
  ...
  { source: 'wingate_30s_avg_power_w', target: 'z_wingate_30s_avg_power_w' },
  ...
  try {
    ...
    const rawRows: Array<Record<string, string | number | null>> = tests.map((test) => {
      ...
      return {
        ...
        wingate_30s_avg_power_w: test.wingate30sAveragePower,
