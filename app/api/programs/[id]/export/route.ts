// app/api/programs/[id]/export/route.ts
//
// Program export with ?format=pdf|json. ProgramOverview's "Export PDF"
// button calls this with format=pdf and downloads the response blob.
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    logError('Error exporting program', error)
    return NextResponse.json(
