  ...
  try {
    ...
    const updatedResult = await prisma.raceResult.update({
      ...
      data: {
        ...
        trainingPaces: vdotResult?.trainingPaces as unknown as Prisma.InputJsonValue | undefined,
        equivalentTimes: vdotResult?.equivalentTimes as unknown as Prisma.InputJsonValue | undefined,
