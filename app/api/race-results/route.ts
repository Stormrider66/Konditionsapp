  ...
  try {
    ...
    const raceResult = await prisma.raceResult.create({
      data: {
        ...
        ageInDays,
        trainingPaces: vdotResult.trainingPaces as unknown as Prisma.InputJsonValue,
        equivalentTimes: vdotResult.equivalentTimes as unknown as Prisma.InputJsonValue,
        goalTime,
