...
function buildFeatureMixOverview(
  ...
  const foodScanner = summarizeCategories(byCategory, [
    'food_scan',
    'food_scan_memory',
    'food_scan_text',
    'food_scan_refine',
  ...
  const heavyInteractive = summarizeCategories(byCategory, [
    ...
    'video_analysis',
    'video_analysis_generic',
    'video_analysis_running_gait',
    'video_analysis_skiing',
    'video_analysis_hyrox',
    'video_pose_analysis',
    'audio_journal_process',
    'adhoc_workout_audio',
    'adhoc_workout_voice',
    'adhoc_workout_voice_parse',
    'adhoc_workout_voice_transcription',
    'adhoc_workout_photo',
    'adhoc_workout_image',
    'program_generation',
...
function formatCategory(category: string): string {
  ...
  const labels: Record<string, string> = {
    ...
    food_scan_text: 'Food scanner text',
    food_scan_refine: 'Food scanner refine',
    food_scan_recipe: 'Food scanner recipe',
    food_scan_audio_transcription: 'Food scanner audio',
    live_voice_coach: 'Live voice coach',
    live_voice_coaching: 'Live voice coach',
    live_voice_summary: 'Live voice summary',
    voice_workout_summary: 'Voice workout summary',
    video_analysis: 'Video analysis',
    video_analysis_generic: 'Video analysis',
    video_analysis_running_gait: 'Video analysis running gait',
    video_analysis_skiing: 'Video analysis skiing',
    video_analysis_hyrox: 'Video analysis HYROX',
    video_pose_analysis: 'Video pose analysis',
    nutrition_plan: 'Nutrition plan',
    daily_wod: 'Daily WOD',
    wod_generation: 'WOD generation',
    audio_journal: 'Audio journal',
    audio_journal_process: 'Audio journal',
    adhoc_workout_audio: 'Ad-hoc workout audio',
    adhoc_workout_voice: 'Ad-hoc workout voice',
    adhoc_workout_voice_parse: 'Ad-hoc workout voice parse',
    adhoc_workout_voice_transcription: 'Ad-hoc workout voice transcription',
    adhoc_workout_photo: 'Ad-hoc workout photo',
    adhoc_workout_image: 'Ad-hoc workout image',
    test_import: 'Test import',
    test_import_image: 'Test import image',
    test_import_document: 'Test import document',
    test_import_audio: 'Test import audio',
    lactate_scan: 'Lactate scan',
    lactate_ocr: 'Lactate OCR',
    athlete_generative_chart: 'Generative chart',
