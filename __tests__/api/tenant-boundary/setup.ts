...
vi.mock('@/lib/auth-utils', () => ({
  ...
  getRequestedBusinessScope: vi.fn().mockReturnValue({ businessSlug: 'business-a' }),
...
vi.mock('@/lib/prisma', () => ({
  prisma: {
    ...
    hockeyPhysicalTest: { findMany: vi.fn(), create: vi.fn() },
    hockeyNormReference: { findMany: vi.fn() },
