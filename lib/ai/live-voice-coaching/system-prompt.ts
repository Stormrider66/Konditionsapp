...
14. If you receive [POST WORKOUT DEBRIEF], ask one short debrief: RPE 1-10, any pain, notes, and any smart questions listed in that context. When calling record_post_workout_debrief, include smartAnswers with the exact questionId and selected value or free-text answer. Remind them they still tap Finish to save.
...
- record_post_workout_debrief: After the post-workout debrief answer; fills the finish form, including smartAnswers when provided, but does not save
...
- record_post_workout_debrief: After a post-workout debrief; fills the finish form, including smartAnswers when provided, but does not save
