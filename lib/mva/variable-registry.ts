...
export const MVA_VARIABLE_REGISTRY: MVAVariable[] = [
  ...
  {
    id: 'hockey_ice_sprint_5m',
    name: 'Ice Sprint 5m',
    nameSv: 'Issprint 5m',
    category: 'PERFORMANCE',
    unit: 's',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.sprint5m ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
  ...
  {
    id: 'hockey_ice_sprint_20m',
    name: 'Ice Sprint 20m',
    nameSv: 'Issprint 20m',
    category: 'PERFORMANCE',
    unit: 's',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.sprint20m ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_ice_sprint_30m',
    name: 'Ice Sprint 30m',
    nameSv: 'Issprint 30m',
    category: 'PERFORMANCE',
    unit: 's',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.sprint30m ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
  ...
  },
  {
    id: 'hockey_vo2max',
    name: 'Hockey VO2max',
    nameSv: 'Hockey VO2max',
    category: 'PERFORMANCE',
    unit: 'ml/kg/min',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.vo2max ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_lt2_speed_kmh',
    name: 'Hockey LT2 Speed',
    nameSv: 'Hockey LT2-fart',
    category: 'PERFORMANCE',
    unit: 'km/h',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.lt2SpeedKmh ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_lt2_heart_rate',
    name: 'Hockey LT2 Heart Rate',
    nameSv: 'Hockey LT2-puls',
    category: 'PHYSIOLOGICAL',
    unit: 'bpm',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.lt2HeartRate ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_max_lactate',
    name: 'Hockey Max Lactate',
    nameSv: 'Hockey maxlaktat',
    category: 'PHYSIOLOGICAL',
    unit: 'mmol/L',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.maxLactate ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_max_heart_rate',
    name: 'Hockey Max Heart Rate',
    nameSv: 'Hockey maxpuls',
    category: 'PHYSIOLOGICAL',
    unit: 'bpm',
    extractor: (bundle) => getLatestHockeyTest(bundle)?.maxHeartRate ?? null,
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
    id: 'hockey_ramp_duration_min',
    name: 'Hockey Ramp Duration',
    nameSv: 'Hockey ramptid',
    category: 'PERFORMANCE',
    unit: 'min',
    extractor: (bundle) => {
      const seconds = getLatestHockeyTest(bundle)?.rampDurationSec
      return seconds ? Math.round((seconds / 60) * 10) / 10 : null
    },
    sportRelevance: ['TEAM_ICE_HOCKEY'],
  },
  {
