...
export function getReferralInviteEmailTemplate(data: ReferralInviteEmailData) {
  ...
  const content = locale === 'sv' ? {
    subject: `${safeReferrerName} har bjudit in dig till ${br.platformName}`,
    greeting: safeRecipientName ? `Hej ${safeRecipientName},` : 'Hej!',
    intro: `${safeReferrerName} tycker att du skulle älska ${br.platformName} och har bjudit in dig att prova plattformen.`,
    benefitTitle: 'Du får:',
    aboutTitle: `Om ${br.platformName}`,
    about: `${br.platformName} är en komplett plattform för prestationstest och träningsplanering. Skapa konditionstester, generera professionella träningsprogram och övervaka idrottare med avancerad analys.`,
    ctaText: 'Registrera dig gratis',
    closing: 'Vi ser fram emot att välkomna dig!',
    team: `${br.platformName}-teamet`
  } : {
    subject: `${safeReferrerName} has invited you to ${br.platformName}`,
    greeting: safeRecipientName ? `Hi ${safeRecipientName},` : 'Hi!',
    intro: `${safeReferrerName} thinks you would love ${br.platformName} and has invited you to try the platform.`,
    benefitTitle: 'You get:',
    aboutTitle: `About ${br.platformName}`,
    about: `${br.platformName} is a complete platform for performance testing and training planning. Create performance tests, generate professional training programs, and monitor athletes with advanced analytics.`,
    ctaText: 'Sign up for free',
    closing: 'We look forward to welcoming you!',
    team: `The ${br.platformName} Team`
  }

  const headerTitle = locale === 'sv' ? '🎁 Du är inbjuden!' : '🎁 You\'re Invited!'
