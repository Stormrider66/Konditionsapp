...
export const INFO_CONTENT: Record<string, InfoEntry> = {
  ...
  aiModels: {
    ...
    detailed: 'Varje AI-modell har styrkor: Claude är bra på nyanserade träningsråd och svenska. Gemini har multimodal kapacitet för video och bild. GPT-modeller har bred kunskap. Coaches kan konfigurera vilka modeller som används, och BYOK (Bring Your Own Key) stöds. För atleter styrs tyngre AI-funktioner av månatliga AI-krediter och eventuella extra påfyllningar.',
    roles: ['COACH'],
    tier: 2,
  },
  ragDocuments: {
  ...
  tokenBudget: {
    key: 'tokenBudget',
    title: 'AI-krediter',
    short: 'Månatlig AI-pott som används av tyngre AI-funktioner och kan fyllas på vid behov.',
    detailed: 'AI-krediter är den månatliga potten för funktioner som mat-skanner, videoanalys, röstcoach, programgenerering och AI-rapporter. FREE har en liten testpott, STANDARD är anpassad för daglig användning och PRO har en större pott för mer avancerade flöden. Elite sätts individuellt tillsammans med coach eller PT. När krediterna är slut kan användaren uppgradera eller köpa extra krediter.',
    roles: [],
    tier: 3,
  },
  careTeamPriority: {
