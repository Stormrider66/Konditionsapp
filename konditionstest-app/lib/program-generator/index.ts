...
function determineWorkoutDistribution(
  ...
  switch (phase) {
    case 'BASE':
      ...
      if (trainingDays >= 3) {
        workouts.push({ dayNumber: 2, type: 'easy', params: { duration: 45 } })
        workouts.push({ dayNumber: 4, type: 'easy', params: { duration: 40 } })
      ...
      if (trainingDays >= 5) {
        workouts.push({ dayNumber: 1, type: 'easy', params: { duration: 30 } })
      }
      if (trainingDays >= 6) {
        workouts.push({ dayNumber: 3, type: 'core', params: {} })
      }
      break
    ...
    case 'BUILD':
      ...
      if (trainingDays >= 3) {
        workouts.push({ dayNumber: 2, type: 'easy', params: { duration: 40 } })
        workouts.push({
          dayNumber: 4,
      ...
      if (trainingDays >= 4) {
        workouts.push({ dayNumber: 5, type: 'strength', params: { focus: 'lower' } })
      }
      if (trainingDays >= 5) {
        workouts.push({
          dayNumber: 1,
    ...
    case 'RECOVERY':
      ...
      if (trainingDays >= 2) {
        workouts.push({ dayNumber: 2, type: 'recovery', params: {} })
        workouts.push({ dayNumber: 5, type: 'easy', params: { duration: 30 } })
      }
      if (trainingDays >= 3) {
        workouts.push({ dayNumber: 3, type: 'core', params: {} })
      }
    ...
    case 'TRANSITION':
      ...
      if (trainingDays >= 3) {
        workouts.push({ dayNumber: 2, type: 'easy', params: { duration: 40 } })
        workouts.push({ dayNumber: 4, type: 'strength', params: { focus: 'full' } })
        workouts.push({ dayNumber: 7, type: 'easy', params: { duration: 50 } })
      }
      break
  }
