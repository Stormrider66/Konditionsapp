...
export function CoachOnboardingClient({
  ...
  const handleComplete = () => {
    router.push(`${basePath}/coach/dashboard`);
  };
  ...
  const quickActions = [
    { href: `${basePath}/coach/test`, icon: ClipboardList, label: t('actionNewTest') },
    { href: `${basePath}/coach/clients/new`, icon: Users, label: t('actionNewAthlete') },
    { href: `${basePath}/coach/programs/new`, icon: Calendar, label: t('actionNewProgram') },
    { href: `${basePath}/coach/ai-studio`, icon: Sparkles, label: t('actionAIStudio') },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-background">
      <div className="container mx-auto py-8 px-4 max-w-3xl">
        ...
        <div className="text-center mt-4">
          <Link href={`${basePath}/coach/dashboard`} className="text-sm text-muted-foreground hover:text-foreground">
            {t('skipOnboarding')}
          </Link>
        </div>
      </div>
