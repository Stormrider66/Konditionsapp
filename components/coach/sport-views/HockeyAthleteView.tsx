...
const PHYSICAL_METRICS = [
  ...
  { key: 'gripMax', label: { sv: 'Grepp max', en: 'Grip max' }, unit: 'kg', decimals: 0 },
  { key: 'standingLongJump', label: { sv: 'Längdhopp', en: 'Standing long jump' }, unit: 'cm', decimals: 0 },
  { key: 'threeJumpBest', label: { sv: '3-steg', en: 'Triple jump' }, unit: 'cm', decimals: 0 },
  { key: 'sprint5m', label: { sv: '5m is', en: '5m ice' }, unit: 's', decimals: 2 },
  { key: 'sprint10m', label: { sv: '10m is', en: '10m ice' }, unit: 's', decimals: 2 },
  { key: 'sprint20m', label: { sv: '20m is', en: '20m ice' }, unit: 's', decimals: 2 },
  { key: 'sprint30m', label: { sv: '30m is', en: '30m ice' }, unit: 's', decimals: 2 },
  { key: 'sprint0to10Kmh', label: { sv: '0-10 fart', en: '0-10 speed' }, unit: 'km/h', decimals: 1 },
  { key: 'sprint10to20Kmh', label: { sv: '10-20 fart', en: '10-20 speed' }, unit: 'km/h', decimals: 1 },
  { key: 'sprint20to30Kmh', label: { sv: '20-30 fart', en: '20-30 speed' }, unit: 'km/h', decimals: 1 },
  { key: 'sprint0to30Kmh', label: { sv: '0-30 fart', en: '0-30 speed' }, unit: 'km/h', decimals: 1 },
