...
const MEAL_METHODS = [
  ...
  {
    id: 'quick' as const,
    labelKey: 'methods.quick.label',
    descriptionKey: 'methods.quick.description',
  ...
  {
    id: 'recipe' as const,
    labelKey: 'methods.recipe.label',
    descriptionKey: 'methods.recipe.description',
...
export function MealInputMethodSelector({
  ...
  const t = useTranslations('components.mealInputMethodSelector')
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" onCloseAutoFocus={(e) => e.preventDefault()}>
        <DialogHeader>
          <DialogTitle className="dark:text-slate-100">{t('title')}</DialogTitle>
          ...
          {MEAL_METHODS.map((method) => (
            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <div className="text-sm text-muted-foreground dark:text-slate-400 truncate">
