...
const goalsBySport: Record<string, Goal[]> = {
  ...
  TEAM_ICE_HOCKEY: [
    ...
    { id: 'conditioning', label: { en: 'Conditioning block', sv: 'Konditionsblock' }, description: { en: 'Repeated sprint ability and shift fitness', sv: 'Upprepad sprintförmåga och byteskondition' }, duration: { en: '8 weeks', sv: '8 veckor' } },
