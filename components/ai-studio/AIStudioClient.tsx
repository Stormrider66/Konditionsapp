...
const COPY = {
  ...
  sv: {
    ...
    budgetTooltip: 'AI-budgetinställningar',
    ...
    researchSharedTitle: 'Research delad',
    researchSharedDescription: 'Researchen har delats med de valda atleterna.',
    starterProgramPrompt: 'Skapa ett 8-veckors träningsprogram för en maratonlöpare',
    starterTestPrompt: 'Analysera min atlets laktattest och föreslå tröskelvärden',
