...
export const FLOATING_CHAT_COPY = {
  en: {
    ...
    teamCaptureGuide: 'Capture setup',
    teamCaptureGuidePrompt: 'Explain how this Team Capture setup should work with Garmin, Concept2 PM5, station receivers, Bluetooth limits, and post-session Workout Evaluation.',
  ...
  sv: {
    ...
    teamCaptureGuide: 'Capture-upplägg',
    teamCaptureGuidePrompt: 'Förklara hur Team Capture-upplägget ska fungera med Garmin, Concept2 PM5, station receivers, Bluetooth-begränsningar och Workout Evaluation efter passet.',
