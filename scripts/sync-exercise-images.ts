...
const EXPLICIT_MAPPINGS: Record<string, string[]> = {
  ...
  'SkiErg': ['skierg'],
  'SkiErg (Calories)': ['skierg'],
  'SkiErg (Meters)': ['skierg'],
  ...
  'Bear Crawl Kettlebell Drag': ['bear-crawl-kettlebell-drag'],
  'Bench Bird Dog Hip Extension': ['bench-bird-dog-hip-extension'],
  ...
  'Lateral Bound Continuous': ['lateral-bound-continuous'],
  'Lateral Bounds': ['lateral-bounds'],
  'Tuck Jumps': ['tuck-jumps'],
  'Split Jumps': ['split-jumps'],
  'Heavy Sled Acceleration': ['heavy-sled-acceleration'],
  'Sled Push March': ['sled-push-march'],
  ...
  'Single-Leg RDL 3-Point Rotation': ['single-leg-rdl-3-point-rotation'],
  'Slider Hamstring Curl': ['slider-hamstring-curl'],
  ...
  'Skater Jump Stick': ['skater-jump-stick'],
  ...
  'Single-Leg Calf Raise Iso Hold': ['single-leg-calf-raise-iso-hold'],
  'Kbox Iso Squat Hold': ['kbox-iso-squat-hold'],
  'Two-Step Side Lift': ['two-step-side-lift'],
}
