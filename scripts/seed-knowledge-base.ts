...
const SKILL_DEFINITIONS: SkillDef[] = [
  ...
  // ── New skills (batch 2) ──────────────────────────────────────────────────
  {
    name: 'Träningszoner & Pulsmodeller',
    nameEn: 'Training Zone Models & Heart Rate Zones',
    category: 'PHYSIOLOGY',
    keywords: ['zoner', 'zones', 'puls', 'heart rate', 'hrmax', 'ftp', 'lthr', 'karvonen', 'cardiac drift', 'decoupling', '3-zon', '5-zon', '7-zon', 'coggan'],
    description: 'Jämförelse av träningszonsmodeller (3-zon Seiler, 5-zon Coggan, norsk laktatmodell). Zonberäkning från laktat, FTP och puls. Cardiac drift, HR decoupling och metriklimitationer.',
    docFiles: [
      { dir: 'knowledge-library', file: 'training-zone-models.md' },
    ],
    priority: 9,
    maxChunks: 3,
  },
  {
    name: 'Rehabilitering & Return to Sport',
    nameEn: 'Rehabilitation & Return to Sport',
    category: 'INJURY_PREVENTION',
    keywords: ['rehabilitering', 'rehab', 'return to sport', 'rts', 'löparknä', 'runners knee', 'pfps', 'itbs', 'hälsena', 'achilles', 'hamstring', 'shin splints', 'lsi', 'hop test'],
    description: 'Rehabiliteringsprotokoll för vanliga uthållighetsidrottsskador (PFPS, ITBS, hälsenetendinopati, medialt tibialt stressyndrom, hamstringsträckning). 4-fas ramverk och return-to-sport testbatteri med LSI.',
    docFiles: [
      { dir: 'knowledge-library', file: 'rehabilitation-return-to-sport.md' },
    ],
    priority: 8,
    maxChunks: 3,
  },
  {
    name: 'HIIT-protokoll',
    nameEn: 'High-Intensity Interval Training Protocols',
    category: 'METHODOLOGY',
    keywords: ['hiit', 'intervall', 'interval', 'billat', '30/30', '4x4', '4x8', 'tabata', 'vo2max intervall', 'sit', 'sprint interval', 'fartlek'],
    description: 'Evidensbaserade HIIT-protokoll: Billat 30/30, Seiler 4x8, norsk 4x4, Tabata. Klassificering av SIT vs aerob HIIT. Optimering av tid vid VO2max, periodisering och HYROX-intervaller.',
    docFiles: [
      { dir: 'knowledge-library', file: 'hiit-protocols.md' },
    ],
    priority: 9,
    maxChunks: 3,
  },
  {
    name: 'Kombinerad Styrke- & Uthållighetsträning',
    nameEn: 'Concurrent Training',
    category: 'STRENGTH',
    keywords: ['concurrent', 'kombinerad', 'interference', 'interferens', 'ampk', 'mtor', 'styrka och löpning', 'styrka och cykling', 'hybridträning'],
    description: 'Interferenseffekten vid kombinerad styrke- och uthållighetsträning. AMPK vs mTOR signalering. Optimalt schema, ordningseffekter, sportspecifika riktlinjer och näring för concurrent training.',
    docFiles: [
      { dir: 'knowledge-library', file: 'concurrent-training.md' },
    ],
    priority: 8,
    maxChunks: 3,
  },
  {
    name: 'Höjd- & Värmeträning',
    nameEn: 'Altitude & Heat Training',
    category: 'PHYSIOLOGY',
    keywords: ['höjd', 'altitude', 'hypoxi', 'hypoxia', 'lhtl', 'epo', 'värme', 'heat', 'acklimatisering', 'acclimatization', 'plasmavolym', 'hemoglobin'],
    description: 'Höjdträning (LHTL, LHTH, IHT) för ökad syretransportkapacitet. Värmeacklimatisering för plasmavolymexpansion. Järnstatus, höjdsjuka, kylstrategier och periodisering av miljöträning.',
    docFiles: [
      { dir: 'knowledge-library', file: 'altitude-heat-training.md' },
    ],
    priority: 7,
    maxChunks: 3,
  },
  {
    name: 'Tävlingsstrategi & Race Day',
    nameEn: 'Race Day Strategy & Competition Execution',
    category: 'PERFORMANCE',
    keywords: ['tävling', 'race', 'pacing', 'negativ split', 'taper', 'tapering', 'tävlingsnäring', 'race nutrition', 'värmeanpassning', 'race day'],
    description: 'Pacingstrategier (negativ/jämn/positiv split). Tävlingsnäring per distans. Väderanpassningar. Tapering-protokoll. Mental förberedelse och split-hantering under tävling.',
    docFiles: [
      { dir: 'knowledge-library', file: 'race-day-strategy.md' },
    ],
    priority: 8,
    maxChunks: 3,
  },
  {
    name: 'Ungdomsidrottsutveckling',
    nameEn: 'Youth Athlete Development',
    category: 'YOUTH',
    keywords: ['ungdom', 'youth', 'junior', 'barn', 'ltad', 'phv', 'peak height velocity', 'tillväxt', 'growth', 'utveckling', 'development', 'osgood-schlatter'],
    description: 'Långsiktig idrottsutveckling (LTAD), Peak Height Velocity (PHV) och träningsanpassningar under tillväxt. Styrketräning för ungdom, tidig specialisering vs multi-sport, relativ ålderseffekt.',
    docFiles: [
      { dir: 'knowledge-library', file: 'youth-athlete-development.md' },
    ],
    priority: 7,
    maxChunks: 3,
  },
  {
    name: 'Masteratletens Träning',
    nameEn: 'Masters Athlete Training (40+)',
    category: 'MASTERS',
    keywords: ['master', 'masters', 'veteran', 'åldrad', 'aging', '40+', '50+', '60+', 'sarkopeni', 'sarcopenia', 'anabolt motstånd', 'bone density'],
    description: 'Träningsanpassningar för atleter över 40. VO2max-nedgång, sarkopeni, modifierad periodisering med längre återhämtning. Styrketräning för benmineral och power. Näring med höjd proteindos.',
    docFiles: [
      { dir: 'knowledge-library', file: 'masters-athlete-training.md' },
    ],
    priority: 7,
    maxChunks: 3,
  },
  {
    name: 'Simträning & Programmering',
    nameEn: 'Swimming Training & Programming',
    category: 'SPORT_SPECIFIC',
    keywords: ['sim', 'swim', 'swimming', 'css', 'critical swim speed', 'crawl', 'freestyle', 'simteknik', 'öppet vatten', 'open water', 'dryland'],
    description: 'Simträning med CSS-testprotokoll, energizoner, teknikdrills (fingertip drag, catch-up, fist drill). Periodisering, dryland-träning, skadeförebyggande och öppet vatten.',
    docFiles: [
      { dir: 'knowledge-library', file: 'swimming-training.md' },
    ],
    priority: 7,
    maxChunks: 3,
  },
  {
    name: 'Bärbar Data & Träningsmätning',
    nameEn: 'Wearable Data & Training Load Metrics',
    category: 'MONITORING',
    keywords: ['tss', 'trimp', 'ctl', 'atl', 'tsb', 'hrv', 'garmin', 'strava', 'whoop', 'pmc', 'training load', 'belastning', 'wearable', 'effektmätare', 'power meter'],
    description: 'TSS, TRIMP och Performance Management Chart (CTL/ATL/TSB). HRV-monitorering med rMSSD. Wearable-plattformar (Strava, Garmin, Whoop). GPS-noggrannhet och effektmätarkalibrering.',
    docFiles: [
      { dir: 'knowledge-library', file: 'wearable-data-training-load.md' },
    ],
    priority: 8,
    maxChunks: 3,
  },
  {
    name: 'Rörlighet & Uppvärmning',
    nameEn: 'Mobility, Warm-up & Movement Preparation',
    category: 'MOBILITY',
    keywords: ['rörlighet', 'mobility', 'uppvärmning', 'warm-up', 'ramp', 'stretching', 'foam rolling', 'cooldown', 'dynamisk', 'fms', 'movement'],
    description: 'RAMP-protokollet för uppvärmning. Sportspecifik rörlighet för löpare, cyklister och simmare. Foam rolling, nedvarvning, rörlighetsscreening och veckovis rörlighetsrutin.',
    docFiles: [
      { dir: 'knowledge-library', file: 'mobility-warmup.md' },
    ],
    priority: 6,
    maxChunks: 3,
  },
  {
    name: 'Lagsportkonditionering',
    nameEn: 'Team Sports Conditioning & GPS Metrics',
    category: 'TEAM_SPORTS',
    keywords: ['lagsport', 'team sport', 'fotboll', 'football', 'soccer', 'gps', 'hsr', 'high speed running', 'sprint', 'rsa', 'repeated sprint', 'ssg', 'small sided', 'md-'],
    description: 'GPS-metrik och trösklar (HSR, sprintdistans, accel/decel). Game Day Minus (MD-) systemet. Repeated Sprint Ability (RSA). Small-Sided Games, positionsspecifik belastning och säsongskonditionering.',
    docFiles: [
  ...
  {
    name: 'Idrottspsykologi & Mental Träning',
    nameEn: 'Sports Psychology & Mental Training',
    category: 'PSYCHOLOGY',
    keywords: ['psykologi', 'psychology', 'mental', 'visualisering', 'visualization', 'flow', 'ångest', 'anxiety', 'mindfulness', 'motivation', 'self-talk', 'pettlep'],
    description: 'PETTLEP-modellen för visualisering. Ångesthantering med box breathing och self-talk. Flow state. Målsättning, pre-tävlingsrutiner, mindfulness och mental periodisering.',
    docFiles: [
      { dir: 'knowledge-library', file: 'sports-psychology.md' },
    ],
    priority: 6,
    maxChunks: 3,
  },
